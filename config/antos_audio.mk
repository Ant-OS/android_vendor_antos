...
ALARM_PATH := vendor/antos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/antos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/antos/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/antos/prebuilt/common/media/audio/ui
